...
class ReviewSchema(BaseModel):
    ...
    key_themes: list[str] = Field(description="The main themes or topics discussed in the text provided.")

    summary: str = Field(..., description="A concise summary of the text provided.")

    sentiment: Literal["pos", "neg", "neutral"] = Field(..., description="The sentiment of the text provided.")

    pros: Optional[str] = Field(None, description="The positive aspects of the text provided.")
    cons: Optional[str] = Field(None, description="The negative aspects of the text provided.")
